...
The MCP server reads `kb_local/` together with the public `kb_minimal/` when building indexes, so anything you drop here becomes searchable by the agent on your machine — but stays off the public repository.
